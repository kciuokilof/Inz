...
void print_ocb_test_case(int   i, 
                         char* K, 
                         char* N, 
                         char* M, 
                         char* C, 
                         char* T)
{
   ...
   ocb_aes_encrypt(keys, N, M, i, C, T);

   printf("\n\nTest case  OCB-AES-%d-%dB", AES_KEY_BITLEN, i);
   printf(  "\nKey        ");  print_hex_string(K, AES_KEY_BITLEN/8);
   printf(  "\nNonce      ");  print_hex_string(N, 16);
   printf(  "\nPlaintext  ");  print_hex_string(M, i);
   printf(  "\nCiphertext ");  print_hex_string(C, i);
   printf(  "\nTag        ");  print_hex_string(T, 16);
}



int print_ocb_test_vectors ( void )
{
    ...
    print_ocb_test_case(   0,key,nonce,pt,ct,tag);
    print_ocb_test_case(   3,key,nonce,pt,ct,tag);
    print_ocb_test_case(  16,key,nonce,pt,ct,tag);
    print_ocb_test_case(  20,key,nonce,pt,ct,tag);
    print_ocb_test_case(  32,key,nonce,pt,ct,tag);
    print_ocb_test_case(  34,key,nonce,pt,ct,tag);
    print_ocb_test_case(1000,key,nonce, z,ct,tag);
    printf("\n");
}
...
int main(void)
{
    printf("Some OCB test vectors\n\n");
    print_ocb_test_vectors();
    printf("\n\n");
